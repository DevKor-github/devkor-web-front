...
const BoxContainer: React.FC<BoxContainerProps> = ({ boxes, Paragraph, ParagraphKey, isMobile}:BoxContainerProps) => {

    const introduction="DevKor는 현실의 문제를 다양한 관점에서 바라보고, 이를 소프트웨어로 해결하려는 사람들이 모인 고려대학교 소프트웨어 개발 연구 학회입니다.";
    return (
